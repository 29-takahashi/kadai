...
<form action="update_execute.php" method="post">
	...
	<div class="form-group">
		...
		<?php
			switch($category_id){
				case 1:
					echo '<input type="checkbox" name="category_id" value="1" checked /> 政治';
					echo '<input type="checkbox" name="category_id" value="2" /> 経済';
					echo '<input type="checkbox" name="category_id" value="3" /> スポーツ';
					echo '<input type="checkbox" name="category_id" value="4" /> 恋愛';
					break;
				case 2:
					echo '<input type="checkbox" name="category_id" value="1" /> 政治';
					echo '<input type="checkbox" name="category_id" value="2" checked /> 経済';
					echo '<input type="checkbox" name="category_id" value="3" /> スポーツ';
					echo '<input type="checkbox" name="category_id" value="4" /> 恋愛';
					break;
				case 3:
					echo '<input type="checkbox" name="category_id" value="1" /> 政治';
					echo '<input type="checkbox" name="category_id" value="2" /> 経済';
					echo '<input type="checkbox" name="category_id" value="3" checked /> スポーツ';
					echo '<input type="checkbox" name="category_id" value="4" /> 恋愛';
					break;
				case 4:
					echo '<input type="checkbox" name="category_id" value="1" /> 政治';
					echo '<input type="checkbox" name="category_id" value="2" /> 経済';
					echo '<input type="checkbox" name="category_id" value="3" /> スポーツ';
					echo '<input type="checkbox" name="category_id" value="4" checked /> 恋愛';
					break;
			}
		?>
	</div>
